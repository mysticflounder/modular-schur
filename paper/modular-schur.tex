...
\author{Adam McKenna\thanks{With automated assistance from Claude (Anthropic) and Aristotle (Harmonic). The Lean~4 proofs of Theorems~\ref{thm:main},~\ref{thm:unified-upper}, and~\ref{thm:unified-lower} were machine-verified by Aristotle \cite{aristotle}. Correspondence: \texttt{flound1129@gmail.com}.}}
\date{\today}
...
\end{verbatim}
compiles in Lean~4 with axiom dependency only \texttt{propext}, \texttt{Classical.choice}, \texttt{Quot.sound}. Source files are available at \url{https://github.com/flound1129/erdos/tree/master/5/lean}.
